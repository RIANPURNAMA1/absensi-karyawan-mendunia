    ...
    <div class="w-full max-w-md relative z-10 fade-in">
        ...
        <div class="glass-effect rounded-3xl shadow-2xl p-8 relative overflow-hidden">
            ...
            <div class="grid grid-cols-2 gap-3">
                <div class="feature-badge bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-xl p-4 text-center border border-blue-200/50">
                    <div class="inline-flex items-center justify-center w-10 h-10 bg-blue-500 rounded-lg mb-2 shadow-lg">
                ...
                <div class="feature-badge bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-xl p-4 text-center border border-blue-200/50">
                    <div class="inline-flex items-center justify-center w-10 h-10 bg-blue-600 rounded-lg mb-2 shadow-lg">
            ...
            <div class="mt-6 pt-6 border-t border-gray-100 text-center">
                <p class="text-xs text-gray-500 font-medium">
                    Belum punya akun? 
                    <a href="#" class="text-blue-600 font-semibold hover:text-blue-700 transition-colors">Hubungi Admin</a>
                </p>
            </div>
        </div>
