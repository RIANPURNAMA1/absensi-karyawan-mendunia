...
<div class="container px-3 py-4">
    ...
    <div class="bg-white border rounded-3 mb-4">
        <div class="p-3 border-bottom d-flex align-items-center justify-content-between">
            <div>
                <h6 class="mb-0" style="font-weight: 600; font-size: 14px;">Data Kehadiran</h6>
                <small class="text-muted">Pantau absensi harian karyawan</small>
            </div>
            <a href="/data-kehadiran" class="btn btn-sm btn-outline-primary" style="font-size: 12px;">Lihat Semua</a>
        </div>
                            ...
                            <td>
                                @php
                                    $badge = match($a->status) {
                                        ...
                                        'IZIN' => 'badge-izin',
                                        'ALPA' => 'badge-alpa',
                                        'PULANG LEBIH AWAL' => 'badge-terlambat',
                                        'TIDAK ABSEN PULANG' => 'badge-alpa',
                                        'LIBUR' => 'badge-izin',
                                        default => 'bg-light text-muted',
                                    };
                                @endphp
                                <span class="badge-status {{ $badge }}">{{ $a->status }}</span>
                            </td>
                        </tr>
                    @empty
                        <tr><td colspan="8" class="text-center text-muted py-4">Belum ada data kehadiran</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
