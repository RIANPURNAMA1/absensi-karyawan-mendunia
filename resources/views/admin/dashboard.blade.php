...
<div class="container px-3 py-4">
    ...
    <div class="d-flex align-items-center justify-content-between mb-3">
        <div>
            <h5 style="font-weight: 600; margin: 0;">Dashboard</h5>
            <small class="text-muted">Ringkasan sistem absensi</small>
        </div>
    </div>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-lg-4">
            <div class="bg-white border rounded-3 p-3 h-100">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div>
                        <h6 class="mb-0" style="font-weight: 600; font-size: 14px;">Komposisi Hari Ini</h6>
