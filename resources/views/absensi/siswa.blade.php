...
<body class="bg-gray-50 pb-24">
    ...
    <div class="px-5 pt-4 pb-2 flex items-center gap-3">
        <button id="btnBack" onclick="backToKelas()"
    ...
    <!-- KELAS LIST VIEW -->
    <div id="kelasView" class="px-5 space-y-3">
        @forelse ($kelasList as $k)
        <button onclick="pilihKelas('{{ $k->id }}', '{{ $k->nama_kelas }}')"
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-xs text-gray-500 mt-0.5">{{ $k->siswas_count }} siswa</p>
                </div>
    ...
    <script>
        ...
        function pilihKelas(kelasId, kelasNama) {
            isDrillDown = true;
            document.getElementById('kelasView').classList.add('hidden');
            document.getElementById('siswaView').classList.remove('hidden');
            document.getElementById('pageTitle').textContent = kelasNama;
        ...
        function backToKelas() {
            if (isDrillDown) {
                isDrillDown = false;
                document.getElementById('kelasView').classList.remove('hidden');
